...
| Q-ReAlign                    | `qrealign` (=`qrealign-mini` by default), `qrealign-lite`, `qrealign-pro`                                            | Modern Q-Align on a Qwen3.5-VL backbone (Mini 0.8B / Lite 4B / Pro 9B), score in `[0, 1]`, `quality`[default]/`aesthetic` tasks. Requires `transformers>=5.0` | Higher is better |
...
| FGResQ                       | `fgresq`, `fgresq_pair`                                                                                             | `fgresq` gives single-image quality; `fgresq_pair` takes two images and returns `(quality0, quality1, rank, rank_prob)` | Higher is better |
...
| MetaIQA                      | `metaiqa`                                                                                                           |                                                                                              | Higher is better |
